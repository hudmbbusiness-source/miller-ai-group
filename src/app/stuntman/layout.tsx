...
// STUNTMAN AI - LAYOUT
// =============================================================================
// Full trading interface layout with navigation
// =============================================================================
...
export const metadata: Metadata = {
  title: 'StuntMan AI | Advanced Crypto Trading',
  description: 'AI-powered cryptocurrency trading system with paper trading, technical analysis, and automated strategies',
}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex items-center gap-1">
                <NavLink href="/stuntman">Dashboard</NavLink>
                <NavLink href="/stuntman/trade">Trade</NavLink>
                <NavLink href="/stuntman/strategies">Strategies</NavLink>
                <NavLink href="/stuntman/backtest">Backtest</NavLink>
                <NavLink href="/stuntman/history">History</NavLink>
              </nav>
            </div>
