...
// All venture logos for the carousel
const ventureLogos = [
...
function HomePageContent() {
  ...
  // Handle OAuth code if it lands on root instead of /auth/callback
  useEffect(() => {
    const code = searchParams.get('code')
    if (code && !isProcessingAuth) {
      setIsProcessingAuth(true)
      console.log('OAuth code detected on root, exchanging for session...')
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="min-h-screen flex flex-col relative overflow-hidden">
        {/* Animated Background with warm accent */}
